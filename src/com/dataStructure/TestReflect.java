...
public class TestReflect {
    ...
    public static void main(String[] args) {
        ...
        new TestReflect().testC("list");
        new TestReflect().testC("hashSet");
        new TestReflect().testC("hashMap");
    }

    private void testC(String type) {
        ...
        switch (type) {
            ...
            //内存泄漏
            case "hashMap":
                HashMap<ReflectPoint, Object> hp = new HashMap<>();
